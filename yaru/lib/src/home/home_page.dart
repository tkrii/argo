...
class HomePageState extends State<HomePage> {
  ...
  final _items = <Widget, (Widget, Widget, String)>{
    ...
    const TextFieldsView(): (const Icon(Ionicons.pencil_outline), const Icon(Ionicons.pencil), 'TextFields'),
    const ColorsView(): (const Icon(Ionicons.color_palette_outline), const Icon(Ionicons.color_palette), 'Palette'),
    const ContainersView(): (const Icon(Ionicons.browsers_outline), const Icon(Ionicons.browsers), 'Containers'),
  };
        ...
        children: [
          ...
          for (var i = 0; i < items.length; i++)
            ListTile(
              ...
              leading: i == selectedIndex ? items.entries.elementAt(i).value.$2 : items.entries.elementAt(i).value.$1,
